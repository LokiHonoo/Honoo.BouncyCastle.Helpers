...
namespace Honoo.BouncyCastle.Helpers
{
    ...
    /// </summary>
    public sealed class ARIA : SymmetricBlockAlgorithm
    {
        #region Properties
        ...
        private const string NAME = "ARIA";
        ...
        /// <summary>
        /// Initializes a new instance of the ARIA class.
        /// </summary>
        public ARIA() : base(NAME, BLOCK_SIZE, DEFAULT_KEY_SIZE)
        {
        }
        ...
        {
            return new SymmetricAlgorithmName(NAME, KIND, BLOCK_SIZE, () => { return new ARIA(); }, false);
        }

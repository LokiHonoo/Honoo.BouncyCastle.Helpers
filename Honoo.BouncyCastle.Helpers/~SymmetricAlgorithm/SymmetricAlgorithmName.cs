...
#pragma warning disable CA1707 // 标识符不应包含下划线
        ...
        /// </summary>
        public static SymmetricAlgorithmName Blowfish { get; } = Honoo.BouncyCastle.Helpers.Blowfish.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 128 bits. Legal key size 128, 192, 256 bits.
        /// </summary>
        public static SymmetricAlgorithmName Camellia { get; } = Honoo.BouncyCastle.Helpers.Camellia.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 64 bits. Legal key size 40-128 bits (8 bits increments).
        /// </summary>
        public static SymmetricAlgorithmName CAST5 { get; } = Honoo.BouncyCastle.Helpers.CAST5.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 128 bits. Legal key size 128-256 bits (8 bits increments).
        /// </summary>
        public static SymmetricAlgorithmName CAST6 { get; } = Honoo.BouncyCastle.Helpers.CAST6.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 64 bits. Legal key size 64 bits.
        /// </summary>
        public static SymmetricAlgorithmName DES { get; } = Honoo.BouncyCastle.Helpers.DES.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 64 bits. Legal key size 128, 192 bits.
        /// </summary>
        public static SymmetricAlgorithmName DESede { get; } = Honoo.BouncyCastle.Helpers.DESede.GetAlgorithmName();
        ...
        /// </summary>
        public static SymmetricAlgorithmName GOST28147 { get; } = Honoo.BouncyCastle.Helpers.GOST28147.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 64 bits. Legal key size 8-128 bits (8 bits increments).
        /// </summary>
        public static SymmetricAlgorithmName IDEA { get; } = Honoo.BouncyCastle.Helpers.IDEA.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 128 bits. Legal key size 128 bits.
        /// </summary>
        public static SymmetricAlgorithmName Noekeon { get; } = Honoo.BouncyCastle.Helpers.Noekeon.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 64 bits. Legal key size 8-1024 bits (8 bits increments).
        /// </summary>
        public static SymmetricAlgorithmName RC2 { get; } = Honoo.BouncyCastle.Helpers.RC2.GetAlgorithmName();
        ...
        /// </summary>
        public static SymmetricAlgorithmName RC5_64 { get; } = Honoo.BouncyCastle.Helpers.RC5_64.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 128 bits. Legal key size is more than or equal to 8 bits (8 bits increments).
        /// </summary>
        public static SymmetricAlgorithmName RC6 { get; } = Honoo.BouncyCastle.Helpers.RC6.GetAlgorithmName();
        ...
        /// Symmetric block algorithm. Block size 128 bits. Legal key size 128 bits.
        /// </summary>
        public static SymmetricAlgorithmName SEED { get; } = Honoo.BouncyCastle.Helpers.SEED.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 128 bits. Legal key size 32-512 bits (32 bits increments).
        /// </summary>
        public static SymmetricAlgorithmName Serpent { get; } = Honoo.BouncyCastle.Helpers.Serpent.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 64 bits. Legal key size 128 bits.
        /// </summary>
        public static SymmetricAlgorithmName SKIPJACK { get; } = Honoo.BouncyCastle.Helpers.SKIPJACK.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 128 bits. Legal key size 128 bits.
        /// </summary>
        public static SymmetricAlgorithmName SM4 { get; } = Honoo.BouncyCastle.Helpers.SM4.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 64 bits. Legal key size 128 bits.
        /// </summary>
        public static SymmetricAlgorithmName TEA { get; } = Honoo.BouncyCastle.Helpers.TEA.GetAlgorithmName();
        ...
        /// Symmetric block algorithm. Block size 128 bits. Legal key size 32-512 bits (32 bits increments).
        /// </summary>
        public static SymmetricAlgorithmName Tnepres { get; } = Honoo.BouncyCastle.Helpers.Tnepres.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 128 bits. Legal key size 128, 192, 256 bits.
        /// </summary>
        public static SymmetricAlgorithmName Twofish { get; } = Honoo.BouncyCastle.Helpers.Twofish.GetAlgorithmName();

        /// <summary>
        /// Symmetric block algorithm. Block size 64 bits. Legal key size 128 bits.
        /// </summary>
        public static SymmetricAlgorithmName XTEA { get; } = Honoo.BouncyCastle.Helpers.XTEA.GetAlgorithmName();
        ...
        /// </summary>
        public static SymmetricAlgorithmName ChaCha { get; } = Honoo.BouncyCastle.Helpers.ChaCha.GetAlgorithmName();

        /// <summary>
        /// ymmetric stream algorithm. Legal key size 256 bits. Legal iv size 96 bits.
        /// </summary>
        public static SymmetricAlgorithmName ChaCha7539 { get; } = Honoo.BouncyCastle.Helpers.ChaCha7539.GetAlgorithmName();

        /// <summary>
        /// ymmetric stream algorithm. Legal key size 128 bits. Legal iv size 0-128 bits (8 bits increments).
        /// </summary>
        public static SymmetricAlgorithmName HC128 { get; } = Honoo.BouncyCastle.Helpers.HC128.GetAlgorithmName();

        /// <summary>
        /// ymmetric stream algorithm. Legal key size 128, 256 bits. Legal iv size 128-256 bits (8 bits increments).
        /// </summary>
        public static SymmetricAlgorithmName HC256 { get; } = Honoo.BouncyCastle.Helpers.HC256.GetAlgorithmName();

        /// <summary>
        /// ymmetric stream algorithm. Legal key size 64-8192 bits (16 bits increments). Not need iv.
        /// </summary>
        public static SymmetricAlgorithmName ISAAC { get; } = Honoo.BouncyCastle.Helpers.ISAAC.GetAlgorithmName();

        /// <summary>
        /// ymmetric stream algorithm. Legal key size 256 bits. Not need iv.
        /// </summary>
        public static SymmetricAlgorithmName RC4 { get; } = Honoo.BouncyCastle.Helpers.RC4.GetAlgorithmName();

        /// <summary>
        /// ymmetric stream algorithm. Legal key size 128, 256 bits. Legal iv size 64 bits.
        /// </summary>
        public static SymmetricAlgorithmName Salsa20 { get; } = Honoo.BouncyCastle.Helpers.Salsa20.GetAlgorithmName();

        /// <summary>
        /// ymmetric stream algorithm. Legal key size 256 bits. Legal iv size 8-6144 bits (8 bits increments).
        /// </summary>
        public static SymmetricAlgorithmName VMPC { get; } = Honoo.BouncyCastle.Helpers.VMPC.GetAlgorithmName();

        /// <summary>
        /// ymmetric stream algorithm. Legal key size 256 bits. Legal iv size 8-6144 bits (8 bits increments).
        /// </summary>
        public static SymmetricAlgorithmName VMPC_KSA3 { get; } = Honoo.BouncyCastle.Helpers.VMPC_KSA3.GetAlgorithmName();

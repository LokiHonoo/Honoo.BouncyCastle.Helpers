...
namespace Honoo.BouncyCastle.Helpers
{
    ...
    public sealed class ChaCha : SymmetricStreamAlgorithm
    {
        ...
        private const string NAME = "ChaCha";
        ...
        /// <summary>
        /// Initializes a new instance of the ChaCha class.
        /// </summary>
        /// <param name="rounds">Rounds must be an even number.</param>
        public ChaCha(int rounds = 20) : base(NAME, DEFAULT_KEY_SIZE, DEFAULT_IV_SIZE)
        {
        ...
        /// <param name="rounds">Rounds must be an even number.</param>
        /// <returns></returns>
        public static ChaCha Create(int rounds = 20)
        {
            return new ChaCha(rounds);
        }
        ...
        {
            return new SymmetricAlgorithmName(NAME, KIND, 0, () => { return new ChaCha(); }, false);
        }

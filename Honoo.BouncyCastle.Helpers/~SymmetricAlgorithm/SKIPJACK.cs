...
namespace Honoo.BouncyCastle.Helpers
{
    ...
    /// </summary>
    public sealed class SKIPJACK : SymmetricBlockAlgorithm
    {
        #region Properties
        ...
        private const string NAME = "SKIPJACK";
        ...
        /// <summary>
        /// Initializes a new instance of the SKIPJACK class.
        /// </summary>
        public SKIPJACK() : base(NAME, BLOCK_SIZE, DEFAULT_KEY_SIZE)
        {
        }
        ...
        {
            return new SymmetricAlgorithmName(NAME, KIND, BLOCK_SIZE, () => { return new SKIPJACK(); }, false);
        }

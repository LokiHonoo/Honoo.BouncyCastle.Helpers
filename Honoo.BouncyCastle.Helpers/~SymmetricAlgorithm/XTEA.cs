...
namespace Honoo.BouncyCastle.Helpers
{
    ...
    public sealed class XTEA : SymmetricBlockAlgorithm
    {
        ...
        private const string NAME = "XTEA";
        ...
        /// <summary>
        /// Initializes a new instance of the XTEA class.
        /// </summary>
        public XTEA() : base(NAME, BLOCK_SIZE, DEFAULT_KEY_SIZE)
        {
        }
        ...
        {
            return new SymmetricAlgorithmName(NAME, KIND, BLOCK_SIZE, () => { return new XTEA(); }, false);
        }

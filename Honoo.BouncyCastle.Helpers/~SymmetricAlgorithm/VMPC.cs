...
namespace Honoo.BouncyCastle.Helpers
{
    ...
    public sealed class VMPC : SymmetricStreamAlgorithm
    {
        ...
        private const string NAME = "VMPC";
        ...
        /// <summary>
        /// Initializes a new instance of the VMPC class.
        /// </summary>
        public VMPC() : base(NAME, DEFAULT_KEY_SIZE, DEFAULT_IV_SIZE)
        {
        }
        ...
        {
            return new SymmetricAlgorithmName(NAME, KIND, 0, () => { return new VMPC(); }, false);
        }

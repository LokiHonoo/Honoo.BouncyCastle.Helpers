namespace Honoo.BouncyCastle.Helpers
{
    ...
    public enum SymmetricCipherMode
    {
        ...
        /// <summary>
        /// Nonce/IV size is more than or equal to 8 bits (8 bits increments). MAC size is between 8 and block size (8 bits increments).
        ...
        /// <summary>
        /// Nonce/IV size is null or less than 120 bits (8 bits increments). MAC size 64-128 bits (8 bits increments).

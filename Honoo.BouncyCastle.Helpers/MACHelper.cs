    ...
    public static class MACHelper
    {
        ...
        public static bool TryGetAlgorithm(string mechanism, int macSize, out IMAC algorithm)
        {
            ...
            switch (mechanism)
            {
                ...
                case "RIJNDAEL-128": case "RIJNDAEL128": return TryGetAlgorithmNano(MACAlgorithms.Rijndael_128_MAC, macSize, out algorithm);
                case "RIJNDAEL-160": case "RIJNDAEL160": return TryGetAlgorithmNano(MACAlgorithms.Rijndael_160_MAC, macSize, out algorithm);
                case "RIJNDAEL-192": case "RIJNDAEL192": return TryGetAlgorithmNano(MACAlgorithms.Rijndael_192_MAC, macSize, out algorithm);
                case "RIJNDAEL-224": case "RIJNDAEL224": return TryGetAlgorithmNano(MACAlgorithms.Rijndael_224_MAC, macSize, out algorithm);
                case "RIJNDAEL-256": case "RIJNDAEL256": return TryGetAlgorithmNano(MACAlgorithms.Rijndael_256_MAC, macSize, out algorithm);
                ...
                case "THREEFISH-256": case "THREEFISH256": return TryGetAlgorithmNano(MACAlgorithms.Threefish_256_MAC, macSize, out algorithm);
                case "THREEFISH-512": case "THREEFISH512": return TryGetAlgorithmNano(MACAlgorithms.Threefish_512_MAC, macSize, out algorithm);
                case "THREEFISH-1024": case "THREEFISH1024": return TryGetAlgorithmNano(MACAlgorithms.Threefish_1024_MAC, macSize, out algorithm);

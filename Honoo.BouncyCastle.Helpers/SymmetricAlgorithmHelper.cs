    ...
    public static class SymmetricAlgorithmHelper
    {
        ...
        public static bool TryGetAlgorithm(string mechanism, out ISymmetricBlockAlgorithm algorithm)
        {
            ...
            switch (mechanism)
            {
                ...
                case "RIJNDAEL-128": case "RIJNDAEL128": algorithm = SymmetricAlgorithms.Rijndael128; return true;
                case "RIJNDAEL-160": case "RIJNDAEL160": algorithm = SymmetricAlgorithms.Rijndael160; return true;
                case "RIJNDAEL-192": case "RIJNDAEL192": algorithm = SymmetricAlgorithms.Rijndael192; return true;
                case "RIJNDAEL-224": case "RIJNDAEL224": algorithm = SymmetricAlgorithms.Rijndael224; return true;
                case "RIJNDAEL-256": case "RIJNDAEL256": algorithm = SymmetricAlgorithms.Rijndael256; return true;
                ...
                case "THREEFISH-256": case "THREEFISH256": algorithm = SymmetricAlgorithms.Threefish256; return true;
                case "THREEFISH-512": case "THREEFISH512": algorithm = SymmetricAlgorithms.Threefish512; return true;
                case "THREEFISH-1024": case "THREEFISH1024": algorithm = SymmetricAlgorithms.Threefish1024; return true;

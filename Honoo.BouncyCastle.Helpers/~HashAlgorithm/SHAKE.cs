...
namespace Honoo.BouncyCastle.Helpers
{
    ...
    public sealed class SHAKE : HashAlgorithm
    {
        ...
        {
            return new HashAlgorithmName($"{NAME}{hashSize / 2}-{hashSize}", hashSize, () => { return new ShakeDigest(hashSize / 2); }, () => { return new SHAKE(hashSize); });
        }

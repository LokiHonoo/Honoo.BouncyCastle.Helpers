...
namespace Test
{
    internal static class ECDHTest
    {
        ...
        private static void Demo1()
        {
            ...
            // Alice work.
            //
            DHParameters parametersA = AsymmetricAlgorithmHelper.ECDH.GenerateParametersA(256, 22);
            AsymmetricCipherKeyPair keyPairA = AsymmetricAlgorithmHelper.ECDH.GenerateKeyPair(parametersA);
            string publicKeyA = PemHelper.KeyToPem(keyPairA.Public);
            ...
            byte[] pmsB = agreementB.CalculateAgreement(keyPairB.Public).ToByteArrayUnsigned();
            //
            // Alice work.
            //

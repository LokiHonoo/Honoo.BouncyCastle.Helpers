    ...
    internal class Program
    {
        private static void Main()
        {
            while (true)
            {
                ...
                Console.WriteLine();
                Console.WriteLine("  K. Key Generator");
                Console.WriteLine("  T. Temporaries");
                Console.WriteLine();
                Console.WriteLine();
                ...
                while (true)
                {
                    ...
                    switch (kc)
                    {
                        ...
                        case 'k': case 'K': Console.Clear(); KeyGenerator.Test(); break;
                        case 't': case 'T': Console.Clear(); Temporaries.Test(); break;
                        default: continue;
                    }
                    break;
                }

...
namespace Test
{
    internal static class Pem
    {
        ...
        private static void Demo()
        {
            ...
            string priKeyPem1 = PemHelper.PrivateKey2Pem(obj.KeyPair.Private);
            string priKeyPem2 = PemHelper.PrivateKey2Pem(obj.KeyPair.Private, PemHelper.DEKAlgorithmNames.AES_128_CBC, "12345");
            string pubKeyPem = PemHelper.PublicKey2Pem(obj.KeyPair.Public);
            ...
            var priKey1 = PemHelper.Pem2PrivateKey(priKeyPem1);
            var priKey2 = PemHelper.Pem2PrivateKey(priKeyPem2, "12345");
            var pubKey1 = PemHelper.Pem2PublicKey(pubKeyPem);
            var cert = PemHelper.Pem2Cert(certPem);
            var crl = PemHelper.Pem2Crl(crlPem);
            var csr = PemHelper.Pem2Csr(csrPem);
            //
            byte[] priKeyRaw1 = RawHelper.PrivateKey2Raw(obj.KeyPair.Private);
            ...
            byte[] pubKeyRaw1 = RawHelper.PublicKey2Raw(obj.KeyPair.Public);
            //
            var priKey11 = RawHelper.Raw2PrivateKey(priKeyRaw1);
            var priKey22 = RawHelper.Raw2PrivateKey(priKeyRaw2, "12345");
            var pubKey11 = RawHelper.Raw2PublicKey(pubKeyRaw1);
            //

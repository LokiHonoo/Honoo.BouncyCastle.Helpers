...
namespace Test
{
    internal static class Pem
    {
        ...
        private static void Demo()
        {
            ...
            string keyPairPem2 = PemHelper.KeyPair2Pem(obj.KeyPair, DEKAlgorithmName.AES_128_CBC, "12345");
            string priKeyPem1 = PemHelper.Key2Pem(obj.KeyPair.Private);
            string priKeyPem2 = PemHelper.Key2Pem(obj.KeyPair.Private, DEKAlgorithmName.AES_128_CBC, "12345");
            ...
            var priKey2 = PemHelper.Pem2Key(priKeyPem2, "12345");
